...
for line in lines:
    ...
    ln = os.system(f'text2image --text={line_training_text} --outputbase={output_directory}/{file_base_name} --max_pages=1 --strip_unrenderable_words --leading=32 --xsize=4000 --ysize=700 --char_spacing=1.0 --exposure=0 --unicharset_file=langdata/eng.unicharset --fontconfig_tmpdir={fontconf_dir} --font="Red Hat Mono" 2>/dev/null')
    if ln == 0:
